## Introduction ##
This branch is exclusive for pixel8 only, it is based on latest sultan zuma kernel branch 16.0.0-sultan and 5ec1cff's KernelSU fork
...
## Requirements ##
- Full Stock Factory Pixel 8 images
...
- Manually hooks ported by SUS_SU and offical KSU

- Reverted the original uname spoof, a stock uname is spoofed during compile time
...
- My prebuilt anykernel3 zip is provided if users just want to use it directly, but again be reminded that back up your own data first as always.
